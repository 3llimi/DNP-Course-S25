[![Review Assignment Due Date](https://classroom.github.com/assets/deadline-readme-button-22041afd0340ce965d47ae6ef1cefeee28c7c493a6346c4f15d667ab976d596c.svg)](https://classroom.github.com/a/CxChE92u)
...
- Example run and output
  ...
  ```bash
  $ python3 client/client.py 127.0.0.1:8080 client/note.txt
...
- Resulting directory structure. The text/image file should arrive intact.
...
- [ ] The code is readable and formatted according to [PEP 8](https://peps.python.org/pep-0008/) (`autopep8 -i -a server.py`)
